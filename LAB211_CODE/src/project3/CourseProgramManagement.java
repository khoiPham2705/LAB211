...
public class CourseProgramManagement {
    ...
    public static void main(String[] args) {
            ...
            switch (choice) {
                case 1:
                    ...
                    do {
                        ...
                        // Hỏi người dùng có muốn tiếp tục quản lý Topic không
                        System.out.print("Do you want to continue managing topics? (yes or no): ");
                        String answer = sc.nextLine().trim().toLowerCase();
                        continueManage = answer.equals("yes");

                    } while (continueManage);
                    break;

                case 2:
                    System.out.println("Manage Course is under development.");
                    break;

                case 3:
                    System.out.println("Manage Learner is under development.");
                    break;
        ...
        } while (cont && choice >= 1 && choice <= 6); // Vòng lặp sẽ chạy cho đến khi người dùng chọn thoát (6)
